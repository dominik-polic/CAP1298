/*
 *	This file defines all the I2C registers of the CAP1298 capacitive touch snesor.
 */

#ifndef __CAP1298_registers_H__
#define __CAP1298_registers_H__


enum CAP1298_Register
{
    MAIN_CONTROL = 0x00,
    GENERAL_STATUS = 0x02,
